            ...
            @if (count($exams) > 0)
                ...
                @foreach ($exams as $exam)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary editMarks" data-marks="{{ $exam->marks }}"
                                data-pass-marks="{{ $exam->pass_marks }}" data-totalque="{{ count($exam->getQnaExam) }}"
                                data-id="{{ $exam->id }}" data-toggle="modal" data-target="#editMarksModal">Edit</button>
                        </td>
                    </tr>
                @endforeach
            @else
                ...
                <form id="editMarks">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" disabled ="Total Marks" id="tmarks">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.editMarks').click(function() {
                ...
                var totalq = $(this).attr('data-totalque');
            ...
            $('#pass_marks').keyup(function() {
                ...
                if (parseFloat(pmarks) >= parseFloat(tmarks)) {
                    $(this).parent().append(
                        '<p style = "color:red;", class = "pass-error">Passing Marks will be less</p>'
                    );
                }
